      ...
      <el-container>
        <el-header class="header" >
          <div class="headerContainer">
            ...
            <h2 class="headerTitle">ModelUpdate</h2>
        ...
        <el-main class="main">
          ...
          <div>
            <div class="formContainer">
              <h2 style="position: absolute; top: 0; left: 5px;">全局模型更新控制台</h2>
              <hr>
              <el-form class="form" :model="form" label-width="auto">
                <el-form-item label="已上传本地模型列表" style="margin-bottom: 0">
                  <el-table :data="modelList" height="150" border style="width: 100%; border: 1px solid gray;">
                    ...
                    <el-table-column label="详情" width="180">
                      <template #default="scope">
                        <el-button @click="handleButtonClick(scope.row)">查看</el-button>
                      </template>
                    </el-table-column>
                  </el-table>
                  <el-button type="primary" style="display: block; margin: 5px auto 20px;
                  background-color: #91d5ff;">更新本地模型列表</el-button>
                </el-form-item>

                <el-form-item label="参与参数聚合模型" style="margin-bottom: 0">
                  <el-table :data="modelList" height="150" border style="width: 100%; border: 1px solid gray;">
                    <el-table-column prop="modelName" label="模型名称" width="180" />
                    <el-table-column prop="uploadTime" label="上传时间" width="180" />
                    <el-table-column label="详情" width="180">
                  ...
                  <el-button type="primary" style="display: block; margin: 5px auto 20px;
                  background-color: #91d5ff;">接收共享参数</el-button>
                </el-form-item>

                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="本地模型更新学习率" style="margin-bottom: 5px">
                      <el-input v-model="updateLearningRate"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="本地模型更新轮数" style="margin-bottom: 5px">
                      <el-input v-model="updateRoundNumber"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <div style="display: flex; justify-content: center; gap: 10px;">
                  <el-button style="background-color:  #bfbfbf;margin-right: 30px" @click="startTraining">
                    更新</el-button>
                  <el-button style="background-color:  #fa541c;margin-left: 30px" @click="stopTraining">
                    取消</el-button>
                </div>
                <el-progress v-if="showProgress" :text-inside="true" :stroke-width="26"
                             :percentage="70" style="margin-top: 20px" />
                <el-form-item label="全局模型保存" style="margin-top: 20px">
                  <el-button type="primary" style="background-color: #91d5ff">选择保存路径</el-button>
                </el-form-item>
              </el-form>
            </div>
          </div>
