...
const radio = ref('certified');
const isCertified = ref(true);
const radioTitle = ref('');
const dataAcquisitionEquipment = ref('');
...
onBeforeMount(() => {
  if (isCertified.value) {
    radioTitle.value = '已认证';
    radio.value = 'certified';
  } else {
    radioTitle.value = '未认证';
    radio.value = 'unCertified';
  }
});
      ...
      <el-container>
        <el-header class="header" >
          <div class="headerContainer" >
            <el-icon class="headerIcon" ><Setting /></el-icon>
            <h2 class="headerTitle">ModelTest</h2>
...
<!--            <el-button type="primary" class="searchButton" :icon="Search" ></el-button>-->
        ...
        <el-main class="main" >
          ...
          <div>
            ...
            >
              <h2 style="position: absolute; top: 0; left: 5px;">全局模型测试控制台</h2>
              <el-form class="form" @mouseover="enlargeDiv($event, 'formContainer')"
                       @mouseleave="resetDiv($event, 'formContainer')" label-width="auto" label-position="top">
                <el-form-item label="测试终端与全局模型服务器认证状态" style="margin-bottom: 20px;">
                  <el-radio v-model="radio" label="certified" :disabled="true" :border="true" >
                    {{ radioTitle }}
                  </el-radio>
                </el-form-item>

                <el-form-item label="选择全局模型" style="margin-bottom: 20px;">
                  <el-upload
                      ref="upload"
                ...
                <el-form-item label="数据采集设备IP地址" style="margin-bottom: 20px;">
                  <el-input v-model="dataAcquisitionEquipment" style="width: 300px; margin-right: 20px;"></el-input>
                  <el-button type="primary" style="background-color: #91d5ff; ">数据采集</el-button>
                  <el-button type="primary" style="background-color: #b5f5ec; ">目标检测</el-button>
                </el-form-item>
                ...
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item label="平均交并比（mIoU）">
                      <el-input v-model="updateLearningRate"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="平均精准度（mAP）">
                      <el-input v-model="updateRoundNumber"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <div style="display: flex; justify-content: center; gap: 10px;">
                  <el-button style="background-color:#bfbfbf;margin-right: 20px">显示检测结果
                  </el-button>
                </div>
