    ...
    <div class="content-container">
        ...
        <el-form :model="ruleForm" :rules="rules"  label-width="100px">
          <el-form-item prop="user">
            <el-input v-model="ruleForm.user" clearable placeholder="用户名">
            </el-input>
          </el-form-item>
          <el-form-item prop="pass">
            <el-input :type="showPassword ? 'text' : 'password'" v-model="ruleForm.pass" placeholder="密码">
              <template #suffix>
          ...
          <el-button type="primary" @click="submitForm" class="registerButton">注册</el-button>
          <p class="have" >已有账号?</p>
