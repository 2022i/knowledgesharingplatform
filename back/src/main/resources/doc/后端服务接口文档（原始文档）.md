...
|---------|-------------|--------|--------|-------------|
|v2025-01-11 22:31:52|2025-01-11 22:31:52|auto|@23831|Created by smart-doc|
...
|id|int32|No comments found.|-|
|authorId|int32|No comments found.|-|
|themeId|int32|No comments found.|-|
|title|string|No comments found.|-|
|summary|string|No comments found.|-|
|content|string|No comments found.|-|
|createTime|string|No comments found.|-|
|relatedKnowledge|array|No comments found.|-|
|collectUserIds|array|No comments found.|-|
|shareUserIds|array|No comments found.|-|
|supportUserIds|array|No comments found.|-|
|opposeUserIds|array|No comments found.|-|
|viewUserIds|array|No comments found.|-|
|check|boolean|No comments found.|-|
|delete|boolean|No comments found.|-|
|draft|boolean|No comments found.|-|
|reject|boolean|No comments found.|-|
...
## 
### 
**URL:** http://127.0.0.1:8081/server/userDeleteArticle
...
**Request-example:**
```bash
curl -X PUT -i 'http://127.0.0.1:8081/server/userDeleteArticle' --data 'articleId=0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/getRenderedArticle?articleId=0&=338'
```
**Response-fields:**
