...
|---------|-------------|--------|--------|-------------|
|v2025-01-13 11:38:24|2025-01-13 11:38:24|auto|@23831|Created by smart-doc|
...
**Request-example:**
```bash
curl -X POST -H 'Content-Type: application/json' -i 'http://127.0.0.1:8081/server/write/updateArticle?=g3a4d9' --data '{
  "authorId": 0,
  "themeId": 0,
  "title": "",
  "content": "",
