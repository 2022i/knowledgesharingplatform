...
|---------|-------------|--------|--------|-------------|
|v2025-01-15 15:08:38|2025-01-15 15:08:38|auto|@23831|Created by smart-doc|
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/articleSearch/orderedCreateTime?userId=0&keyword=' --data '&0'
```
**Response-fields:**
...
| Parameter | Type | Required | Description | Since |
|-----------|------|----------|-------------|-------|
|currentUserId|int32|true|No comments found.|-|
|followUserId|int32|true|No comments found.|-|

**Request-example:**
```bash
curl -X PUT -i 'http://127.0.0.1:8081/server/follow/followUser' --data 'currentUserId=0&followUserId=0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/getList/hotArticles?userId=0' --data '&0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/articleSearch/default?userId=0&keyword=' --data '&0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X PUT -i 'http://127.0.0.1:8081/server/follow/unFollowUser' --data 'currentUserId=0&followUserId=0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/articleSearch/orderedSupportCount?userId=0&keyword=' --data '&0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/getRenderedArticle?articleId=0&userId=0' --data '&0&0'
```
**Response-fields:**
...
**Request-example:**
```bash
curl -X GET -i 'http://127.0.0.1:8081/server/theme/getAllThemeAndArticleCount?userId=0' --data '&0'
```
**Response-fields:**
