...
public class ShareArticlesController {
    ...
    public List<RenderedArticle> getShareArticles(@RequestParam int userId) {
        return renderedArticleBooleanSet.setRenderedArticleBoolean(articleRenderingPreparation.getRenderedArticles(shareArticlesList.getArticlesList(userId)),userId);
    }
}
